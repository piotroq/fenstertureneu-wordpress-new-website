...
if ( ! defined( 'AIOSEO_LICENSING_URL' ) ) {
	define( 'AIOSEO_LICENSING_URL', 'https://aioseo.gpltimes.com/v1/' );
}
if ( ! defined( 'AIOSEO_LICENSE_KEY' ) ) {
	define( 'AIOSEO_LICENSE_KEY', 'B5E0B5F8DD8689E6ACA49DD6E6E1A930' );
}
add_action( 'admin_menu', function() {
	// Remove Search Statistics menu
