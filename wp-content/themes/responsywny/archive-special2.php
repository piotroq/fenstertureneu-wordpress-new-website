...
<?php include('custom-header.php'); ?>
     ...
     <main id="custompost-content" role="main">
      <div class="container clearfix">
        ...
        <div class="cp-maintitle">Türen</div>
     ...
     $wp_query->query('showposts=6&post_type=special2&orderby=name&order=ASC'.'&paged='.$paged);?>
      ...
      <?php while ( have_posts() ) : the_post();?>
        ...
        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
          <div class="custompost-entry clearfix">
                   ...
                   */
                  get_template_part( 'special2', get_post_format() );
                  ?>
